...
class Tube_VC_Videos_List {
  ...
  function manage_video_url_admin_column( $column, $post_id ) {
   ...
   function show_videos_list( $videos, $site ){ 
    ...
    $source_term_ids = get_post_meta( $source_post_id, 'tube_source_term_ids', true );
        ...
        <div class="result video-status-<?php echo sanitize_html_class($existing_video_data['status']); ?>">
          ...
          <div class="tube-video-summary">
            ...
            <p class="video-title">  
              ...
              <?php endif; ?>
                <a href="<?php echo esc_url( $video['media_url'] ); ?>" target="_blank"><strong><?php echo esc_html( $video['title'] ); ?></strong></a>
            </p>
          ...
          <div class="tube-video-buttons tube-video-pending-buttons">
            ...
            <a  class="btn-edit" href="<?php if (  $existing_video_data['status'] == 'pending' ) echo $existing_video_data['permalink']; ?>">
             ...
             <div class="tube-video-buttons tube-video-new-buttons">
                ...
                <a data-site="<?php echo esc_attr($site); ?>"  data-title="<?php echo esc_attr($video['title']); ?>" data-channel-id="<?php echo esc_attr($video['channel_id']); ?>"  data-id="<?php echo $video['id']; ?>" data-src="<?php echo esc_url($video['media_url']); ?>" data-content="<?php echo esc_attr($video['content']); ?>" data-date="<?php echo $video['date']; ?>" data-embed-url="<?php echo esc_url($video['embed_url']); ?>" data-media-url="<?php echo esc_url($video['media_url']); ?>" data-image-url="<?php echo esc_url($video['image_url']); ?>" data-creator-name="<?php echo esc_attr($video['creator_name']); ?>"  data-term-ids="<?php echo esc_attr($source_term_ids); ?>" data-tags="<?php echo esc_attr($tags); ?>"  data-status="publish" class="btn-import btn-publish button button-primary" href="#"><?php _e( 'Publish', 'tube-video-curator' ); ?></a>
                
                <br />
                
               <a data-site= "<?php echo esc_attr($site); ?>" data-title= "<?php echo esc_attr($video['title']); ?>" data-channel-id="<?php echo esc_attr($video['channel_id']); ?>"  data-id="<?php echo $video['id']; ?>" data-src="<?php echo esc_url($video['media_url']); ?>" data-content="<?php echo esc_attr($video['content']); ?>" data-date="<?php echo $video['date']; ?>" data-embed-url="<?php echo $video['embed_url']; ?>" data-media-url="<?php echo esc_url($video['media_url']); ?>" data-image-url="<?php echo esc_url($video['image_url']); ?>" data-creator-name="<?php echo esc_attr($video['creator_name']); ?>"  data-term-ids="<?php echo esc_attr($source_term_ids); ?>" data-tags="<?php echo esc_attr($tags); ?>" data-status="pending" class="btn-import btn-pending" href="#"><?php _e( 'Pending', 'tube-video-curator' ); ?></a>
                
                <br />
                
               <a data-site= "<?php echo esc_attr($site); ?>" data-title= "<?php echo esc_attr($video['title']); ?>" data-channel-id="<?php echo esc_attr($video['channel_id']); ?>"  data-id="<?php echo $video['id']; ?>" data-src="<?php echo $video['media_url']; ?>" data-content="<?php echo esc_attr($video['content']); ?>" data-date="<?php echo $video['date']; ?>" data-embed-url="<?php echo esc_url($video['embed_url']); ?>" data-media-url="<?php echo esc_url($video['media_url']); ?>" data-image-url="<?php echo $video['image_url']; ?>" data-creator-name="<?php echo esc_attr($video['creator_name']); ?>"   data-term-ids="<?php echo esc_attr($source_term_ids); ?>" class="btn-skip" href="#"><?php _e( 'Skip', 'tube-video-curator' ); ?></a>
